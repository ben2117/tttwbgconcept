...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/card.PNG", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
			type.set ("assets/images/images-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/images/loadGame.png", "assets/images/loadGame.png");
			type.set ("assets/images/loadGame.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/scroll.png", "assets/images/scroll.png");
			type.set ("assets/images/scroll.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/startGame.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/_EmptyWorld.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/_Farm.png", "assets/images/_Farm.png");
			type.set ("assets/images/_Farm.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/_Shelter.png", "assets/images/_Shelter.png");
			type.set ("assets/images/_Shelter.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/music/music-goes-here.txt", "assets/music/music-goes-here.txt");
			type.set ("assets/music/music-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/music/Xenomorphs.wav", "assets/music/Xenomorphs.wav");
			type.set ("assets/music/Xenomorphs.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
