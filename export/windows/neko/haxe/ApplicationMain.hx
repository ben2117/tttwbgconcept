...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Games With Colurs", "Thet Wanted To Be Great", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "They Wanted To Be Great", null, { width: 640, height: 480 });
